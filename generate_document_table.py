    ...
    for project, docs in pbar:
        ...
        project_rows = list(map(lambda doc: { 
            ...
            **doc.label_counts,
            ...
            'NP-counts-Interviewer' : ling.get_np_counts(doc.content_by_speaker("Interviewer")),
            'NP-counts-Participant' : ling.get_np_counts(doc.content_by_speaker("Participant")),
            'NP-ratio-Interviewer' : ling.get_np_ratios(doc.content_by_speaker("Participant")),
            'NP-ratio-Participant' : ling.get_np_ratios(doc.content_by_speaker("Interviewer"))
        }, docs))
